...
const envSchema = z
  .object({
    ...
    LEAPING_FUNC_TOKEN: z.string().trim().min(1).optional(),
    LEAPING_FUNC_API_KEY: z.string().trim().min(1).optional(),
    LEAPING_FUNC_VNR_ENDPOINT: z.string().trim().min(1).default('kunde_vnr.php'),
    LEAPING_FUNC_PLZ_GEB_ENDPOINT: z.string().trim().min(1).default('kunde_plzb.php'),
    LEAPING_FUNC_VNR_PARAM: z.string().trim().min(1).default('insurance_number'),
    LEAPING_FUNC_PLZ_PARAM: z.string().trim().min(1).default('plz'),
    LEAPING_FUNC_HNR_PARAM: z.string().trim().min(1).default('hnr'),
    LEAPING_FUNC_BDAY_PARAM: z.string().trim().min(1).default('bday'),
