...
const SCENARIOS: Scenario[] = [
  ...
  {
    id: 38,
    name: 'Confirmed VNR goes to customer lookup',
    brain: 'vnr',
    session_id: 'vnr-038',
  ...
  {
    id: 39,
    name: 'Confirmed VNR internal format valid',
    brain: 'vnr',
    session_id: 'vnr-039',
    steps: [{ input: { vnr_candidate: 'L039359923', vnr_confirmed: true } }],
    expect: { action_type: 'CALL_FUNCTION', function_name: 'get_customer_by_insurance_number' },
  ...
  {
    id: 40,
    name: 'Invalid VNR shape before lookup',
    brain: 'vnr',
    session_id: 'vnr-040',
    steps: [{ input: { vnr_candidate: '039359923', vnr_confirmed: true } }],
    expect: { next_action: 'ASK_VNR_LETTER', function_name: null },
  },
  {
    id: 41,
