...
const LEAPING_FUNCTIONS = [
  {
    ...
    notes: 'VNR lookup via Marie PHP API.',
    safe: true,
  ...
  },
  {
    ...
    notes: 'Address lookup via Marie PHP API.',
    safe: true,
    productionChanging: false,
  },
  {
    ...
    type: 'MCP Tool',
    method: 'POST',
    url: '(MCP proxies GET kunde_vnr.php)',
    parameters: ['insurance_number'],
    notes: 'Safe VNR lookup — no full CRM payload.',
    safe: true,
    productionChanging: false,
  },
  {
    ...
    type: 'MCP Tool',
    method: 'POST',
    url: '(MCP proxies GET kunde_plzb.php)',
    parameters: ['plz', 'hnr', 'bday'],
    notes: 'Safe address lookup — no full CRM payload.',
    safe: true,
    productionChanging: false,
  },
  {
